...
export class CustomComboboxComponent implements AfterViewInit,OnInit{
  ...
  @Input() myControl: AbstractControl = new FormControl();
   filteredOptions: Observable<MyItem[]> = new Observable<MyItem[]>();
   ...
   ngAfterViewInit(): void {
    ...
    public displayFn(item:MyItem):string{
